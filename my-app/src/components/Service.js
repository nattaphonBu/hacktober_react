          ...
          <div className="container">
            ...
            <div className="row align-items-stretch">
              ...
              >
                <div className="unit-4 d-flex">
                  <div className="unit-4-icon mr-4">
                    <span className="text-primary flaticon-house" />
                  </div>
                  <div>
                    <h3>Find Property</h3>
                    <p>
              ...
              >
                <div className="unit-4 d-flex">
                  <div className="unit-4-icon mr-4">
                    <span className="text-primary flaticon-coin" />
                  </div>
                  <div>
                    <h3>Buy Property</h3>
                    <p>
              ...
              >
                <div className="unit-4 d-flex">
                  <div className="unit-4-icon mr-4">
                    <span className="text-primary flaticon-home" />
                  </div>
                  <div>
              ...
              >
                <div className="unit-4 d-flex">
                  <div className="unit-4-icon mr-4">
                    <span className="text-primary flaticon-flat" />
                  </div>
                  <div>
              ...
              >
                <div className="unit-4 d-flex">
                  <div className="unit-4-icon mr-4">
                    <span className="text-primary flaticon-location" />
                  </div>
                  <div>
              ...
              >
                <div className="unit-4 d-flex">
                  <div className="unit-4-icon mr-4">
                    <span className="text-primary flaticon-mobile-phone" />
                  </div>
                  <div>
                    <h3>Mobile Apps</h3>
                    <p>
